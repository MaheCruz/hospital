...
{
$_SESSION['msg1']="La anterior contraseña no coincide !!";
}
}
?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<title>Paciente  | Actualizar contraseña</title>
...
{
alert("Ingrese la anterior contraseña !!");
...
{
alert("La nueva contraseña con su confirmación no coincide  !!");
document.chngpwd.cfpass.focus();
return false;
}
return true;
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<div class="container-fluid container-fullw bg-white">
							...
							<input type="password" name="cpass" class="form-control"  placeholder="Ingresa la anterior contraseña">
														</div>
														<div class="form-group">
