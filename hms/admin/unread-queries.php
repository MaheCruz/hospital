...
<html lang="es">
    <head>
        <title>Admin | Gestionar Consultas Sin Leer</title>
...
<?php include('include/sidebar.php');?>
            <div class="app-content">
                ...
                <!-- fin: BARRA SUPERIOR DE NAVEGACIÓN -->
                <div class="main-content" >
                    <div class="wrap-content container" id="container">
                        ...
                        <section id="page-title">
                            <div class="row">
                                <div class="col-sm-8">
                                    <h1 class="mainTitle">Admin | Gestionar Consultas Sin Leer</h1>
                                                                    </div>
                                <ol class="breadcrumb">
                                    <li>
                                        <span>Admin</span>
                        ...
                        <div class="container-fluid container-fullw bg-white">
                                    ...
                                    <div class="row">
                                <div class="col-md-12">
                                    <h5 class="over-title margin-bottom-15">Gestionar <span class="text-bold">Consultas Sin Leer</span></h5>
