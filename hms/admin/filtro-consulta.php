        ...
        <div class="main-content">
            <div class="wrap-content container" id="container">
                ...
                <div class="container-fluid container-fullw bg-white">
                    <div class="row">
                        <div class="col-md-12">
                        <form role="form" method="post" action="filtro-pac.php">
                            ...
                            <div class="form-group">
                                <label for="searchName">Buscar Doctor/Paciente:</label>
                                <input type="text" class="form-control" name="searchName" placeholder="Ingrese nombre" />
                            </div>
