...
?>
                                            ...
                                            <tr>
                                                ...
                                                <a href="edit-users.php?editid=<?php echo $row['id'];?>"><i class="fa fa-edit"></i></a> 
                                                ...
                                                <div class="visible-xs visible-sm hidden-md hidden-lg">
                                                    <div class="btn-group" dropdown is-open="status.isopen">
                                                        ...
                                                        <ul class="dropdown-menu pull-right dropdown-light" role="menu">
                                                            <li><a href="edit-user.php?id=<?php echo $row['id']?>">Editar</a></li>
                                                            <li><a href="share-user.php?id=<?php echo $row['id']?>">Compartir</a></li>
                                                            <li><a href="manage-users.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('¿Estás seguro de que quieres eliminar?')">Eliminar</a></li>
                                                        </ul>
                                                    </div>
                                                </div></td>
                                            </tr>
