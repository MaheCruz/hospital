...
if(isset($_POST['submit']))
  {
   ...
   $pres=$_POST['pres'];
    ...
    if ($query) {
    echo '<script>alert("El historial médico a sido actualizado.")</script>';
    echo "<script>window.location.href ='manage-patient.php'</script>";
  }
  else
    {
      echo '<script>alert("Ocurrio un error, vuelve a intertarlo")</script>';
    }
...
<th>Peso kg</th>
<th>Nivel de azucar en la sangre</th>
...
<p align="center">                            
 <button class="btn btn-primary waves-effect waves-light w-lg" data-toggle="modal" data-target="#myModal">Añadir Historial Médico</button></p>  
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <th>Nivel de azucar en la sangre:</th>
    <td>
    <input name="bs" placeholder="(70-180 mg/dl)" class="form-control wd-450" required="true"></td>
  </tr> 
  <tr>
    <th>Peso:</th>
    <td>
    <input name="weight" placeholder="Peso kg" class="form-control wd-450" required="true"></td>
  </tr>
  <tr>
    <th>Temperatura corporal:</th>
    <td>
